...
{
    /// <inheritdoc />
    public partial class cornreport : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TesteAflatoxina = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    ArdidoQueimado = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Fermentados = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Carunchados = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PartidosQuebrados = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CornReport", x => x.Id);
                });
        }
